...
doc: "Some workflow engines won't stage files in our nested structure, so parse it\
  \ out here"
requirements:
...
steps:
  align_and_tag:
    ...
    in:
      ...
      fastq1:
        source: unaligned
        valueFrom: "$(self.sequence.hasOwnProperty('fastq1')? self.sequence.fastq1\
          \ : null)"
      fastq2:
        source: unaligned
        valueFrom: "$(self.sequence.hasOwnProperty('fastq2')? self.sequence.fastq2\
          \ : null)"
      readgroup:
        source: unaligned
