  ...
  haplotype_caller:
    ...
    in:
      ...
      output_file_name:
        ...
        valueFrom: '${ var prefix = self !== null ? self : ""; if (inputs.intervals.length
          == 1 && inputs.intervals[0].match(/^[0-9A-Za-z]+$/)) { return prefix + inputs.intervals[0]
          + ".g.vcf.gz"; } else { return prefix + "output.g.vcf.gz"; } }'
    out: [gvcf]
outputs:
  gvcf:
    type: File[]
