...
steps:
  collect_insert_size_metrics:
    ...
    out: [insert_size_metrics, insert_size_histogram]
  ...
  collect_detailed_hs_metrics:
    ...
    out: [per_base_coverage_metrics, per_base_hs_metrics, per_target_coverage_metrics,
  ...
  verify_bam_id:
    ...
    out: [verify_bam_id_metrics, verify_bam_id_depth]
outputs:
  insert_size_metrics:
    type: File
