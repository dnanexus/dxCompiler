...
steps:
  ...
  varscan:
    ...
    out: [somatic_snvs, somatic_indels, somatic_hc_snvs, somatic_hc_indels]
  merge_scattered_somatic_snvs:
    ...
    in:
      ...
      sequence_dictionary:
        source: reference
        valueFrom: '$( (self.secondaryFiles !== undefined) ? self.secondaryFiles.find(function(x)
          { return x.nameext === ".dict" }) : self.replace(/.fa$/,".dict") )'
      merged_vcf_basename:
