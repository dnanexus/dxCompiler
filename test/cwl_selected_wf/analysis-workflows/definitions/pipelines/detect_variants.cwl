...
inputs:
  ...
  roi_intervals:
    ...
    doc: "roi_intervals is a list of regions (in interval_list format) within which\
...
steps:
  mutect:
    ...
    out: [unfiltered_vcf, filtered_vcf]
  strelka:
  ...
  tumor_bam_readcount:
    ...
    out: [snv_bam_readcount_tsv, indel_bam_readcount_tsv]
  ...
  add_tumor_bam_readcount_to_vcf:
    ...
    out: [annotated_bam_readcount_vcf]
