...
- A high-level [list of changes]([doc/WdlVersionChanges.md](https://github.com/openwdl/wdl/blob/main/versions/Differences.md#draft-2-to-10)) between WDL draft-2 and version 1.0
